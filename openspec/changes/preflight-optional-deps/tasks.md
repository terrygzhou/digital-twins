...
## 1. Preflight gate
- [ ] 1.1 In `digital_twins/health.py`, add a `SOFT_DEPS = {"neo4j"}` module
...
- [ ] 1.2 Confirm the `run_pipeline` docstring (L147) is still accurate:
...
- [ ] 2.1 In `digital_twins/ingest/pipeline.py`, ensure `run_pipeline`
...
- [ ] 3.2 Run `PYTHONPATH=. python3.12 -m pytest
