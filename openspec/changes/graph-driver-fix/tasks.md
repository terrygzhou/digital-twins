...
## 1. Driver contract
- [x] 1.1 In `digital_twins/ingest/pipeline.py`, replace `neo4j.run(...)` calls
...
- [x] 1.2 Confirm `digital_twins/scheduler/loop.py::build_neo4j_driver`
...
## 2. Tests
- [x] 2.1 Extend `tests/integration/test_neo4j_query.py::_RecordingDriver`
...
- [x] 2.2 Add a regression test that the driver is a real `neo4j.driver`
...
- [x] 3.2 Run `python3.12 -m pytest tests/integration/test_neo4j_query.py -q`
